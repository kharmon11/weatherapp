        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
            <defs>
                ...
                <radialGradient id="cupGradient" cx="0.3" cy="0.3" r="0.7" fx="0.4" fy="0.4">
                    ...
                    {/*light highlight */}
                    <stop offset="60%" stop-color="#ffec66"/>
                    {/* mid tone */}
                    <stop offset="100%" stop-color="#e6c800"/>
                    {/* shadow */}
                </radialGradient>
            </defs>
            ...
            <g>
                ...
                <path d="M50 75.5 A5 5 0 0 1 50 97" stroke="orange" fill="url(#cupGradient)" stroke-width="2"/>
                <path d="M27.92 37.24 A5 5 0 0 1 9.31 26.49" stroke="orange" fill="url(#cupGradient)" stroke-width="2"/>
